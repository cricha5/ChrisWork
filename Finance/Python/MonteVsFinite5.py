...
tBegin = time.time()
value = EuropeanOption2.valueBlackScholes(S_init,Strike,Exp_Time,Int_Rate,Vol,PTYPE)
tEnd = time.time()
...
nAssetSteps = 1*2**4
tBegin = time.time()
value = EuropeanOption2.valueFiniteDifferenceGPU(ctx,queue,S_init,S_max,nAssetSteps,Strike,Exp_Time,Int_Rate,Vol,PTYPE,3)
tEnd = time.time()
...
tBegin = time.time()
value = EuropeanOption2.valueMonteCarloGPU(ctx,queue,S_init,nPaths,Exp_Time, dtMonte,Strike,Int_Rate,Vol,PTYPE)
tEnd = time.time()

#value = EuropeanOption2.valueMonteCarloGPU(ctx,queue,S_init,nPaths,Exp_Time, dtMonte,Strike,Int_Rate,Vol,PTYPE, nMonteLoops)
