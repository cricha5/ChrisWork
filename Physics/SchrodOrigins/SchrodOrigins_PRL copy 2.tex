...
The boundary between where quantum mechanics ends and classical mechanics begins is being pushed by experiments operating far from the microscopic scale in which quantum behavior is normally associated.  For example, Arndt \emph{et al.}~\cite{bib:arndt} observed interference between mesoscopic fullerenes and Lee \emph{et al.}'s~\cite{bib:leediamonds} experiment entangled the vibrational modes of two macroscopic diamonds.  It is therefore important to be able to describe the manner in which quantum theory transitions into classical theory and to be able to define what elements are responsible for the separation.  There is no doubt that all the behavior of classical mechanics is contained entirely within quantum theory.  The Ehrenfest theorem states this explicitly by saying that the expected mean values of measurement predicted from quantum mechanics obey classical Newtonian motion in the classical regime.  The usual way to approach semi-classic quantum mechanics is to use approximations to quantum mechanics such as WKB~\cite{bib:wkb} or Gross-Pitaevskii~\cite{bib:gpg,bib:gpp}.  Here we take a different approach that allows us to explore one of the fundamental differences between quantum and classical mechanics, linearity.

The linearity inherent in quantum mechanics is evident from the Schr\"{o}dinger wave equation.  To contrast this linear quantum behavior to classical behavior the two theories must be represented in the same language.


  Therefore to be able to find the difference between and quantum and classical theory they must be represented in the same language.

The boundary between where quantum mechanics ends and classical mechanics begins is being pushed by experiments operating far from the microscopic scale in which quantum behavior is normally associated.  For example, Arndt \emph{et al.}~\cite{bib:arndt} observed interference between mesoscopic fullerenes and Lee \emph{et al.}'s~\cite{bib:leediamonds} experiment entangled the vibrational modes of two macroscopic diamonds.  It is therefore important to be able to describe the manner in which quantum \CR{theory transitions into classical theory and to be able to define what elements are responsible for the separation.}.  There is no doubt that all the behavior of classical mechanics can be expressed entirely with quantum theory.  The Ehrenfest theorem states this explicitly by saying that the expected mean values of measurement predicted from quantum mechanics obey classical Newtonian motion in the classical regime.  However, as quantum mechanics enters the transition area between the classical and quantum regimes it becomes increasingly difficult to represent a quantum system using the full quantum formalism.  It is often unfeasible to model a complex or large quantum system without performing some sort of approximation.  It is for this reason that methods such as WKB~\cite{bib:wkb} or Gross-Pitaevskii~\cite{bib:gpg,bib:gpp} were developed which make approximations to quantum theory in order to describe semiclassical behavior.



What is the difference between classical and quantum mechanics?

If we really want to find the difference..

This approach of taking a complete theory such as quantum mechanics and using approximations to describe a theory like classical mechanics seems the natural one but

\CR{This approach of taking a complete theory such as quantum mechanics and using approximations to describe a theory like classical mechanics seems the natural one but while exploring the origin of the Schr\"{o}dinger equation Schleich \emph{et al.}~\cite{bib:revisited} have recently taken the opposite tack and derived quantum mechanics starting from classical mechanics.  In doing so they use a nonlinear wave equation for classical mechanics derived by Oriols and Mompart~\cite{bib:obm} similar in form to the Schr\"{o}dinger equation but which allows no quantum or wavelike features.  The transition from classical theory to quantum theory and the Schr\"{o}dinger equation is then done by eliminating the nonlinearity from the classical wave equation, for quantum mechanics is after all a linear theory.  However, the linear behavior that we associate with quantum mechanics (superposition, interference, probabilistic interpretation, etc.) can come from a wave equation which is non-linear.  A wave equation can be devised similar to Oriols and Mompart's classical wave equation with a scaled nonlinearity.  We derive this equation, which we call the \emph{transition} equation, by first expressing the quantum and classical theories in a consistent language and then modifying Oriols and Mompart's~\cite{bib:obm} nonlinear wave equation for classical mechanics.  We then demonstrate the nature of the transition equation and its quantum-like behavior by an analytic and numerical analysis.  We show that it is equivalent to the Schr\"{o}dinger equation with a rescaled Planck's constant and we reinforce this equivalence by numerically exploring the standard single particle interference problem.}


%
%While exploring the origin go the Schr\"{o}dinger equation Schleich \emph{et al.}~\cite{bib:revisited} also derive a nonlinear wave equation for classical mechanics and they argue that 
%
%
%Schleich \emph{et al.}~\cite{bib:revisited} show that to return to quantum mechanics and to recover the Schr\"{o}dinger equation the nonlinearity must be eliminated.  We explore here the relaxation of this requirement.  We find that, while necessary to recover true quantum mechanics, it is not necessary to completely cancel out the nonlinearity to recover linear quantum behavior.  It is actually enough to scale the nonlinearity and we show in this case that the resulting nonlinear wave equation can still reproduce all the features of quantum mechanics resulting from the linear Schr\"{o}dinger equation.   We derive this equation, which we call the \emph{transition} equation by first expressing the quantum and classical theories in a consistent language and then modifying Oriols and Mompart's~\cite{bib:obm} nonlinear wave equation for classical mechanics.  We then demonstrate the nature of the transition equation and its quantum-like behavior by an analytic and numerical analysis.  We show that it is equivalent to the Schr\"{o}dinger equation with a rescaled Planck's constant and we reinforce this equivalence by numerically exploring the standard single particle interference problem.
